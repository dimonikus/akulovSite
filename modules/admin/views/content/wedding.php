...
foreach (Image::getGalleryImages('uploads/wedding/') as $img) {
    ...
    <p>
        ...
        echo FileInput::widget([
            ...
            'pluginOptions' => [
                ...
                'uploadUrl' => Url::to(['/admin/content/wedding']),
            ...
            'pluginEvents' => [
                "fileuploaded" => "function(event, data, previewId, index) {
                    window.location.href = '/admin/content/wedding';
                }",
            ]
        ]);
        ?>
